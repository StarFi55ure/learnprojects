// $ANTLR 3.5.2 Expr.g 2019-02-21 17:10:43
...
public class ExprParser extends Parser {
		...
		try {
			...
			switch (alt2) {
				...
				case 2 :
					...
					{
					ID4=(Token)match(input,ID,FOLLOW_ID_in_stat69);  
					stream_ID.add(ID4);

					char_literal5=(Token)match(input,13,FOLLOW_13_in_stat71);  
					...
					NEWLINE7=(Token)match(input,NEWLINE,FOLLOW_NEWLINE_in_stat75);  
				...
				case 3 :
					// Expr.g:13:7: NEWLINE
					{
					NEWLINE8=(Token)match(input,NEWLINE,FOLLOW_NEWLINE_in_stat95);  
				...
				case 1 :
					...
					switch (alt3) {
						case 1 :
							// Expr.g:16:18: '+' ^
							{
							char_literal10=(Token)match(input,11,FOLLOW_11_in_expr128); 
						...
						case 2 :
							// Expr.g:16:23: '-' ^
							{
							char_literal11=(Token)match(input,12,FOLLOW_12_in_expr131); 
	...
	public final ExprParser.multExpr_return multExpr() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_atom_in_multExpr149);
			atom13=atom();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					// Expr.g:19:17: '*' ^ atom
					{
					char_literal14=(Token)match(input,10,FOLLOW_10_in_multExpr152); 
		...
		try {
			...
			switch (alt6) {
				...
				case 2 :
					...
					ID17=(Token)match(input,ID,FOLLOW_ID_in_atom181); 
				...
				case 3 :
					...
					char_literal18=(Token)match(input,8,FOLLOW_8_in_atom189); 
					...
					char_literal20=(Token)match(input,9,FOLLOW_9_in_atom194); 
					}
					break;
	...
	public static final BitSet FOLLOW_ID_in_stat69 = new BitSet(new long[]{0x0000000000002000L});
	public static final BitSet FOLLOW_13_in_stat71 = new BitSet(new long[]{0x0000000000000130L});
	...
	public static final BitSet FOLLOW_11_in_expr128 = new BitSet(new long[]{0x0000000000000130L});
	public static final BitSet FOLLOW_12_in_expr131 = new BitSet(new long[]{0x0000000000000130L});
	public static final BitSet FOLLOW_multExpr_in_expr135 = new BitSet(new long[]{0x0000000000001802L});
	public static final BitSet FOLLOW_atom_in_multExpr149 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_10_in_multExpr152 = new BitSet(new long[]{0x0000000000000130L});
	...
	public static final BitSet FOLLOW_ID_in_atom181 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_8_in_atom189 = new BitSet(new long[]{0x0000000000000130L});
	public static final BitSet FOLLOW_expr_in_atom192 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_atom194 = new BitSet(new long[]{0x0000000000000002L});
}
